...
const leaveApprovalDetails = createResource({
	url: "indian_hrms_compliance.api.get_leave_approval_details",
...
const leaveTypes = createResource({
	url: "indian_hrms_compliance.api.get_leave_types",
	params: {
...
function setTotalLeaveDays() {
	...
	const leaveDays = createResource({
		url: "indian_hrms_compliance.hr.doctype.leave_application.leave_application.get_number_of_leave_days",
		params: {
			employee: currEmployee.value,
...
function setLeaveBalance() {
	...
	const leaveBalance = createResource({
		url: "indian_hrms_compliance.hr.doctype.leave_application.leave_application.get_leave_balance_on",
		params: {
			employee: currEmployee.value,
