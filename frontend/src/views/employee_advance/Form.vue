...
const employeeCurrency = createResource({
	url: "indian_hrms_compliance.payroll.doctype.salary_structure_assignment.salary_structure_assignment.get_employee_currency",
...
const advanceAccount = createResource({
	url: "indian_hrms_compliance.api.get_advance_account",
