...
def execute():
	...
	hrms_v = frappe.get_attr("indian_hrms_compliance" + ".__version__")

	WIKI_URL = "https://github.com/frappe/indian_hrms_compliance/wiki/Changes-to-branching-and-versioning"
