...
from indian_hrms_compliance.setup import before_uninstall as remove_custom_fields
...
def before_uninstall():
	try:
		...
		BUG_REPORT_URL = "https://github.com/frappe/indian_hrms_compliance/issues/new"
		click.secho(
