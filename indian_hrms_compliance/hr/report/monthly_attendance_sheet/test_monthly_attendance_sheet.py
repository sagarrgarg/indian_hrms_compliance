...
from indian_hrms_compliance.hr.doctype.leave_allocation.leave_allocation import OverlapError
from indian_hrms_compliance.hr.doctype.leave_application.test_leave_application import make_allocation_record
from indian_hrms_compliance.hr.doctype.shift_type.test_shift_type import setup_shift_type
from indian_hrms_compliance.hr.report.monthly_attendance_sheet.monthly_attendance_sheet import execute
from indian_hrms_compliance.payroll.doctype.salary_slip.test_salary_slip import (
	make_holiday_list,
	make_leave_application,
)
from indian_hrms_compliance.tests.test_utils import create_company, create_department, get_first_day_for_prev_month
