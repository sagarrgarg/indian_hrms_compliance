...
from indian_hrms_compliance.hr.doctype.vehicle_log.test_vehicle_log import get_vehicle, make_vehicle_log
from indian_hrms_compliance.hr.doctype.vehicle_log.vehicle_log import make_expense_claim
from indian_hrms_compliance.hr.report.vehicle_expenses.vehicle_expenses import execute
