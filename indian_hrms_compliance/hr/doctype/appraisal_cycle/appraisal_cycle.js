...
frappe.ui.form.on("Appraisal Cycle", {
		...
		await Promise.all(
			["Employee", "Appraisal Cycle", "Appraisal"].map((doctype) =>
				frappe.model.with_doctype(doctype, () => {
					autocompletions.push(...indian_hrms_compliance.get_doctype_fields_for_autocompletion(doctype));
				}),
			),
		);
	...
	show_appraisal_summary(frm) {
		...
		frappe
			.call("indian_hrms_compliance.hr.doctype.appraisal_cycle.appraisal_cycle.get_appraisal_cycle_summary", {
