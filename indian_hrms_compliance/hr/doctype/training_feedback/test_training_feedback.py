...
from indian_hrms_compliance.hr.doctype.training_event.test_training_event import (
	create_training_event,
	create_training_program,
)
from indian_hrms_compliance.payroll.doctype.salary_structure.test_salary_structure import make_employee
