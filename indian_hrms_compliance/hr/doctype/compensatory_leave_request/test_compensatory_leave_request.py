...
from indian_hrms_compliance.hr.doctype.attendance_request.test_attendance_request import get_employee
from indian_hrms_compliance.hr.doctype.leave_allocation.test_leave_allocation import create_leave_allocation
from indian_hrms_compliance.hr.doctype.leave_application.leave_application import get_leave_balance_on
...
class TestCompensatoryLeaveRequest(FrappeTestCase):
	...
	def test_request_on_leave_period_boundary(self):
		frappe.db.delete("Leave Period")
		create_leave_period("2023-01-01", "2023-12-31")
		...
		create_leave_period("2024-01-01", "2024-12-31")
