...
frappe.treeview_settings["Goal"] = {
	get_tree_nodes: "indian_hrms_compliance.hr.doctype.goal.goal.get_children",
	filters: [
		{
			fieldname: "company",
			fieldtype: "Select",
	...
	get_tree_root: false,
	add_tree_node: "indian_hrms_compliance.hr.doctype.goal.goal.add_tree_node",
...
function update_progress(node, progress) {
	return frappe
		.call({
			method: "indian_hrms_compliance.hr.doctype.goal.goal.update_progress",
			args: {
