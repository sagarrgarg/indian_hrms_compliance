...
from indian_hrms_compliance.hr.doctype.job_opening.test_job_opening import get_job_opening
from indian_hrms_compliance.hr.doctype.job_requisition.job_requisition import make_job_opening
