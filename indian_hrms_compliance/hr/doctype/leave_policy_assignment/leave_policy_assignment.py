...
class LeavePolicyAssignment(Document):
	...
	def calculate_leaves_for_passed_period(
		...
		from indian_hrms_compliance.hr.utils import get_monthly_earned_leave as get_periodically_earned_leave
...
def is_earned_leave_applicable_for_current_period(date_of_joining, allocate_on_day, earned_leave_frequency):
	from indian_hrms_compliance.hr.utils import get_semester_end, get_semester_start
