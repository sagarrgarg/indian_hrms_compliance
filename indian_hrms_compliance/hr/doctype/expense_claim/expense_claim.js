...
frappe.provide("indian_hrms_compliance.hr");
...
frappe.ui.form.on("Expense Claim", {
	...
	make_payment_entry: function (frm) {
		let method = "indian_hrms_compliance.overrides.employee_payment_entry.get_payment_entry_for_employee";
		if (frm.doc.__onload && frm.doc.__onload.make_payment_via_journal_entry) {
			method = "indian_hrms_compliance.hr.doctype.expense_claim.expense_claim.make_bank_entry";
		}
		return frappe.call({
			method: method,
			args: {
	...
	company: function (frm) {
		...
		for (var i = 0; i < expenses.length; i++) {
			...
			frappe.call({
				method: "indian_hrms_compliance.hr.doctype.expense_claim.expense_claim.get_expense_claim_account_and_cost_center",
				args: {
	...
	get_advances: function (frm) {
		...
		if (frm.doc.employee) {
			return frappe.call({
				method: "indian_hrms_compliance.hr.doctype.expense_claim.expense_claim.get_advances",
				args: {
					employee: frm.doc.employee,
				},
