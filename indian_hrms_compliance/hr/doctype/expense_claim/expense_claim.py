...
from indian_hrms_compliance.hr.utils import set_employee_name, share_doc_with_approver, validate_active_employee
...
class ExpenseClaim(AccountsController, PWANotificationsMixin):
	...
	def publish_update(self):
		...
		indian_hrms_compliance.refetch_resource("indian_hrms_compliance:my_claims", employee_user)
		indian_hrms_compliance.refetch_resource("indian_hrms_compliance:team_claims")
