...
from indian_hrms_compliance.hr.doctype.interview.interview import (
	DuplicateInterviewRoundError,
	get_feedback,
	get_skill_wise_average_rating,
	update_job_applicant_status,
)
from indian_hrms_compliance.hr.doctype.job_applicant.job_applicant import get_interview_details
from indian_hrms_compliance.tests.test_utils import create_job_applicant, get_email_by_subject
...
class TestInterview(FrappeTestCase):
	...
	def test_notification_for_scheduling(self):
		from indian_hrms_compliance.hr.doctype.interview.interview import send_interview_reminder
	...
	def test_notification_for_feedback_submission(self):
		from indian_hrms_compliance.hr.doctype.interview.interview import send_daily_feedback_reminder
	...
	def test_skill_wise_average_rating(self):
		from indian_hrms_compliance.hr.doctype.interview_feedback.test_interview_feedback import create_interview_feedback
