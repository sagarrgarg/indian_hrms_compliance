...
from indian_hrms_compliance.hr.doctype.staffing_plan.staffing_plan import ParentCompanyError, SubsidiaryCompanyError
...
class TestStaffingPlan(FrappeTestCase):
	...
	def test_staffing_details_from_job_requisition(self):
		from indian_hrms_compliance.hr.doctype.job_requisition.test_job_requisition import make_job_requisition
