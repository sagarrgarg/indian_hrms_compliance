...
frappe.ui.form.on("Employee Advance", {
	...
	make_deduction_via_additional_salary: function (frm) {
		frappe.call({
			method: "indian_hrms_compliance.hr.doctype.employee_advance.employee_advance.create_return_through_additional_salary",
			args: {
				doc: frm.doc,
			},
			callback: function (r) {
	...
	make_payment_entry: function (frm) {
		...
		if (frm.doc.__onload && frm.doc.__onload.make_payment_via_journal_entry) {
			method = "indian_hrms_compliance.hr.doctype.employee_advance.employee_advance.make_bank_entry";
		}
		return frappe.call({
			method: method,
			args: {
	...
	make_expense_claim: function (frm) {
		return frappe.call({
			method: "indian_hrms_compliance.hr.doctype.expense_claim.expense_claim.get_expense_claim",
			args: {
	...
	make_return_entry: function (frm) {
		frappe.call({
			method: "indian_hrms_compliance.hr.doctype.employee_advance.employee_advance.make_return_entry",
			args: {
