...
indian_hrms_compliance.hr.AttendanceControlPanel = class AttendanceControlPanel extends frappe.ui.form.Controller {
	onload() {
	...
	get_template() {
		...
		window.location.href = repl(
			...
			{
				cmd: "indian_hrms_compliance.hr.doctype.upload_attendance.upload_attendance.get_template",
	...
	show_upload() {
		...
		new frappe.ui.FileUploader({
			wrapper: $wrapper,
			method: "indian_hrms_compliance.hr.doctype.upload_attendance.upload_attendance.upload",
		});
...
cur_frm.cscript = new indian_hrms_compliance.hr.AttendanceControlPanel({ frm: cur_frm });
