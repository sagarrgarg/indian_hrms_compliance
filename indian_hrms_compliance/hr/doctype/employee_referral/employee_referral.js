...
frappe.ui.form.on("Employee Referral", {
	...
	create_job_applicant: function (frm) {
		frappe.model.open_mapped_doc({
			method: "indian_hrms_compliance.hr.doctype.employee_referral.employee_referral.create_job_applicant",
			frm: frm,
		});
	},
	...
	create_additional_salary: function (frm) {
		frappe.call({
			method: "indian_hrms_compliance.hr.doctype.employee_referral.employee_referral.create_additional_salary",
			args: {
				doc: frm.doc,
			},
			callback: function (r) {
