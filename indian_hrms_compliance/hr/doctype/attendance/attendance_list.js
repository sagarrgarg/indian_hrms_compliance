frappe.listview_settings["Attendance"] = {
				...
				primary_action(data) {
					if (cur_dialog.no_unmarked_days_left) {
						...
						frappe.confirm(
							...
							() => {
								frappe.call({
									method: "indian_hrms_compliance.hr.doctype.attendance.attendance.mark_bulk_attendance",
									args: {
										data: data,
									},
								});
	...
	get_unmarked_days: function (dialog) {
		...
		if (fields.employee.value && fields.from_date.value && fields.to_date.value) {
			...
			frappe
				.call({
					method: "indian_hrms_compliance.hr.doctype.attendance.attendance.get_unmarked_days",
					async: false,
					args: {
