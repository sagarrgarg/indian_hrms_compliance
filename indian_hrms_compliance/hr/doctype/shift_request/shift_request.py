...
class ShiftRequest(Document, PWANotificationsMixin):
	...
	def publish_update(self):
		...
		indian_hrms_compliance.refetch_resource("indian_hrms_compliance:my_shift_requests", employee_user)
		indian_hrms_compliance.refetch_resource("indian_hrms_compliance:team_shift_requests")
