...
frappe.ui.form.on("Shift Assignment Tool", {
	setup(frm) {
		indian_hrms_compliance.setup_employee_filter_group(frm);
	},
	...
	refresh(frm) {
		...
		indian_hrms_compliance.handle_realtime_bulk_action_notification(
			frm,
	...
	render_employees_datatable(frm, employees) {
		...
		indian_hrms_compliance.render_employees_datatable(frm, columns, employees, no_data_message);
	},
	...
	bulk_assign(frm, employees) {
		...
		indian_hrms_compliance.validate_mandatory_fields(frm, selected_employees);
		frappe.confirm(
	...
	process_shift_requests(frm, status) {
		...
		indian_hrms_compliance.validate_mandatory_fields(frm, selected_requests, "Shift Requests");
		frappe.confirm(
