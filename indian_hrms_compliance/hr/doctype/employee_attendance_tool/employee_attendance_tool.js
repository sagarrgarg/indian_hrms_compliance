frappe.ui.form.on("Employee Attendance Tool", {
	...
	load_employees(frm) {
		...
		frappe
			.call({
				method: "indian_hrms_compliance.hr.doctype.employee_attendance_tool.employee_attendance_tool.get_employees",
				args: {
					date: frm.doc.date,
	...
	mark_full_day_attendance(frm, employees_to_mark_full_day, employees_to_mark_half_day) {
		frappe
			.call({
				method: "indian_hrms_compliance.hr.doctype.employee_attendance_tool.employee_attendance_tool.mark_employee_attendance",
				args: {
