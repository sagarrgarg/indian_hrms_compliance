...
from indian_hrms_compliance.hr.doctype.leave_allocation.leave_allocation import (
...
class TestLeaveAllocation(FrappeTestCase):
	...
	def test_carry_forward_leaves_expiry_after_partially_used_leaves(self):
		from indian_hrms_compliance.payroll.doctype.salary_slip.test_salary_slip import make_leave_application
	...
	def test_leave_addition_after_submit_with_carry_forward(self):
		from indian_hrms_compliance.hr.doctype.leave_application.test_leave_application import (
