...
from indian_hrms_compliance.hr.doctype.leave_application.leave_application import get_approved_leaves_for_period
from indian_hrms_compliance.hr.doctype.leave_ledger_entry.leave_ledger_entry import (
	create_leave_ledger_entry,
	expire_allocation,
	process_expired_allocation,
)
from indian_hrms_compliance.hr.utils import create_additional_leave_ledger_entry, get_leave_period, set_employee_name
from indian_hrms_compliance.hr.utils import get_monthly_earned_leave as _get_monthly_earned_leave
...
def show_expire_leave_dialog(expired_leaves, leave_type):
	frappe.msgprint(
		...
		primary_action={
			...
			"server_action": "indian_hrms_compliance.hr.doctype.leave_allocation.leave_allocation.expire_carried_forward_allocation",
