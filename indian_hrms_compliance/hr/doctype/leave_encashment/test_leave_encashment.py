...
from indian_hrms_compliance.hr.doctype.expense_claim.test_expense_claim import get_payable_account
from indian_hrms_compliance.hr.doctype.leave_allocation.leave_allocation import get_unused_leaves
from indian_hrms_compliance.hr.doctype.leave_ledger_entry.leave_ledger_entry import process_expired_allocation
from indian_hrms_compliance.hr.doctype.leave_period.test_leave_period import create_leave_period
from indian_hrms_compliance.hr.doctype.leave_policy.test_leave_policy import create_leave_policy
from indian_hrms_compliance.hr.doctype.leave_policy_assignment.leave_policy_assignment import (
	create_assignment_for_multiple_employees,
)
from indian_hrms_compliance.payroll.doctype.salary_slip.test_salary_slip import (
	make_holiday_list,
	make_leave_application,
)
from indian_hrms_compliance.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
from indian_hrms_compliance.tests.test_utils import get_first_sunday
...
class TestLeaveEncashment(FrappeTestCase):
	...
	def test_status_of_leave_encashment_after_payment_via_salary_slip(self):
		from indian_hrms_compliance.payroll.doctype.salary_slip.test_salary_slip import make_employee_salary_slip
	...
	def test_status_of_leave_encashment_after_payment_via_payment_entry_and_fnf(self):
		from indian_hrms_compliance.hr.doctype.full_and_final_statement.test_full_and_final_statement import (
			create_full_and_final_statement,
		)
		from indian_hrms_compliance.overrides.employee_payment_entry import get_payment_entry_for_employee
