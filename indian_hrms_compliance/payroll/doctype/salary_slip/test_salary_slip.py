...
from indian_hrms_compliance.hr.doctype.leave_allocation.test_leave_allocation import create_leave_allocation
from indian_hrms_compliance.hr.doctype.leave_type.test_leave_type import create_leave_type
from indian_hrms_compliance.payroll.doctype.employee_tax_exemption_declaration.test_employee_tax_exemption_declaration import (
	create_exemption_category,
	create_payroll_period,
)
from indian_hrms_compliance.payroll.doctype.payroll_entry.payroll_entry import get_month_details
from indian_hrms_compliance.payroll.doctype.salary_slip.salary_slip import (
...
from indian_hrms_compliance.payroll.doctype.salary_slip.salary_slip_loan_utils import if_lending_app_installed
from indian_hrms_compliance.payroll.doctype.salary_structure.salary_structure import make_salary_slip
from indian_hrms_compliance.tests.test_utils import get_email_by_subject, get_first_sunday
...
class TestSalarySlip(FrappeTestCase):
	...
	def test_leave_details(self):
		from indian_hrms_compliance.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_component_amount_dependent_on_another_payment_days_based_component(self):
		from indian_hrms_compliance.payroll.doctype.salary_structure.test_salary_structure import (
	...
	def test_salary_slip_generation_against_opening_entries_in_ssa(self):
		...
		from indian_hrms_compliance.payroll.doctype.payroll_period.payroll_period import get_period_factor
		from indian_hrms_compliance.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_tax_payable_with_tax_relief_and_marginal_relief_limits(self):
		from indian_hrms_compliance.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
		from indian_hrms_compliance.regional.india.setup import setup
