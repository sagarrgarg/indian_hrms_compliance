...
frappe.ui.form.on("Salary Slip", {
	...
	set_end_date: function (frm) {
		frappe.call({
			method: "indian_hrms_compliance.payroll.doctype.payroll_entry.payroll_entry.get_end_date",
			args: {
	...
	set_payment_days_description: function (frm) {
		...
		frappe.call("indian_hrms_compliance.payroll.utils.get_payroll_settings_for_payment_days").then((r) => {
			const {
				payroll_based_on,
