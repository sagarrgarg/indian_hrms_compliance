...
from indian_hrms_compliance.payroll.doctype.employee_benefit_application.employee_benefit_application import (
	get_benefit_component_amount,
)
from indian_hrms_compliance.payroll.doctype.employee_benefit_claim.employee_benefit_claim import (
	get_benefit_claim_amount,
	get_last_payroll_period_benefits,
)
from indian_hrms_compliance.payroll.doctype.payroll_entry.payroll_entry import get_salary_withholdings, get_start_end_dates
from indian_hrms_compliance.payroll.doctype.payroll_period.payroll_period import (
	get_payroll_period,
	get_period_factor,
)
from indian_hrms_compliance.payroll.doctype.salary_slip.salary_slip_loan_utils import (
...
class SalarySlip(TransactionBase):
	...
	def publish_update(self):
		...
		frappe.publish_realtime(
			event="indian_hrms_compliance:update_salary_slips",
...
def enqueue_email_salary_slips(names) -> None:
	...
	frappe.enqueue("indian_hrms_compliance.payroll.doctype.salary_slip.salary_slip.email_salary_slips", names=names)
	frappe.msgprint(
