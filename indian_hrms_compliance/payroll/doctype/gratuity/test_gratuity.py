...
from indian_hrms_compliance.payroll.doctype.gratuity.gratuity import get_last_salary_slip
...
def setup_gratuity_rule(name: str) -> dict:
	from indian_hrms_compliance.regional.united_arab_emirates.setup import setup
