...
from indian_hrms_compliance.hr.utils import DuplicateDeclarationError
...
class TestEmployeeTaxExemptionDeclaration(FrappeTestCase):
	...
	def test_india_hra_exemption_with_multiple_assignments(self):
		from indian_hrms_compliance.payroll.doctype.salary_slip.test_salary_slip import create_tax_slab
