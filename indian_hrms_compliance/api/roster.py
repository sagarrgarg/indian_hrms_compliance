...
from indian_hrms_compliance.hr.doctype.shift_assignment.shift_assignment import ShiftAssignment
from indian_hrms_compliance.hr.doctype.shift_assignment_tool.shift_assignment_tool import create_shift_assignment
