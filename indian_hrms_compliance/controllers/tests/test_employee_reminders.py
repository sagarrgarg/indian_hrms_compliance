...
from indian_hrms_compliance.controllers.employee_reminders import send_holidays_reminder_in_advance
from indian_hrms_compliance.hr.doctype.hr_settings.hr_settings import set_proceed_with_frequency_change
from indian_hrms_compliance.hr.utils import get_holidays_for_employee
...
class TestEmployeeReminders(FrappeTestCase):
	...
	def test_birthday_reminders(self):
		...
		from indian_hrms_compliance.controllers.employee_reminders import (
	...
	def test_work_anniversary_reminder_not_sent_for_0_years(self):
		...
		from indian_hrms_compliance.controllers.employee_reminders import get_employees_having_an_event_today
	...
	def test_advance_holiday_reminders_monthly(self):
		from indian_hrms_compliance.controllers.employee_reminders import send_reminders_in_advance_monthly
	...
	def test_advance_holiday_reminders_weekly(self):
		from indian_hrms_compliance.controllers.employee_reminders import send_reminders_in_advance_weekly
