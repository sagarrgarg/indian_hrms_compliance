...
from indian_hrms_compliance.setup import delete_custom_fields
	...
	return {
		...
		"Employee": [
			...
			},
			{
				...
				"no_copy": 1,
				"translatable": 0,
				"description": "Full 12-digit Aadhaar — Verhoeff-checksum validated. Display masked elsewhere; last-4 auto-derived for audit views.",
			},
			{
				...
				"read_only": 1,
				"translatable": 0,
				"description": "Auto-derived from the Aadhaar number above — retained for UAN-Aadhaar linkage and DPDP audit reports.",
			},
			{
				"fieldname": "nps_pran",
				"label": "NPS PRAN",
